(() => {
  ...
  function ensureThemeFixes() {
    ...
    if (isDashboard) {
      ...
      addStylesheet('/style/mobile-modals-v11.css?v=20260817-2', 'data-rrn-mobile-modals-v11');
      addStylesheet('/style/mobile-info-modal-v12.css?v=20260817-1', 'data-rrn-mobile-info-modal-v12');
      addScript('/js/mobile-info-modal-reset.js?v=20260817-3', 'data-rrn-mobile-info-modal-reset');
      addScript('/js/mobile-modal-accessibility-guard.js?v=20260817-1', 'data-rrn-mobile-modal-accessibility-guard');
      addScript('/js/mobile-modals-authority.js?v=20260817-2', 'data-rrn-mobile-modals-authority');
    }
  }
