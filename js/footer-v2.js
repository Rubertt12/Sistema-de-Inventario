(() => {
  ...
  function ensurePageEnhancements(){
    ...
    if(portal){
      addStyle('/style/support-portal-fullscreen-v2.css','data-rrn-portal-fullscreen-v2');
      addStyle('/style/support-chat-identities.css','data-rrn-chat-identities');
      addStyle('/style/support-profile-modal.css?v=20260814-1','data-rrn-support-profile-modal');
      addScript('/js/support-profile-ui.js','data-rrn-support-profile-ui');
      addScript('/js/support-profile-presets-v2.js?v=20260814-1','data-rrn-support-profile-presets-v2');
    }
    else if(desk){
      addStyle('/style/support-chat-identities.css','data-rrn-chat-identities');
      addStyle('/style/support-profile-modal.css?v=20260814-1','data-rrn-support-profile-modal');
